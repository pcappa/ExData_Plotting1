...
#   plot2.R
#   
#   This program plots a line graph of global active power consumed between 
...
#	Open the PNG device, plot to the device, then close the device.

out.fname <- paste(fdir, "\\", "plot2.png", sep="")
